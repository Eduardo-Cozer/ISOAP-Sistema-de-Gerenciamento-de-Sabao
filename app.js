...
class App {
    ...
    routes(produtoInstance, pedidoInstance, clienteInstance, usuarioInstance, despesaInstance) {
        ...
        this.app.get("/clientes/deletar/:id", AdminMiddleware.checkAdmin,(req, res) => clienteInstance.delete(req, res))
        ...
        this.app.get("/produtos/deletar/:id", AdminMiddleware.checkAdmin,(req, res) => produtoInstance.delete(req, res))
        ...
        this.app.get("/pedidos/pdf/:id", AdminMiddleware.checkAdmin,(req, res) => pedidoInstance.generatePDF(req, res))
        ...
        this.app.get("/despesas/deletar/:id", AdminMiddleware.checkAdmin,(req, res) => despesaInstance.delete(req, res))
    }
