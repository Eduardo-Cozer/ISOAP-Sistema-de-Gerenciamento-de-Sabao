...
class App {
    ...
    routes(produtoInstance, pedidoInstance, clienteInstance, usuarioInstance, despesaInstance) {
        ...
        this.app.get("/clientes/deletar/:id", (req, res) => clienteInstance.delete(req, res))
        ...
        this.app.get("/produtos/deletar/:id", (req, res) => produtoInstance.delete(req, res))
        ...
        this.app.get("/despesas/deletar/:id", (req, res) => despesaInstance.delete(req, res))
    }
